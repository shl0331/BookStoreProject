function makePaginationHtml(listRowCount, pageCountPerBlock, currentPageIndex, totalListItemCount, htmlTargetId, listFunc){
   ...
   if(prev){
      paginationHtml += 
         '<li><a href="javascript:movePage(' + (startPageIndex - 1) + ')" class="single-btn prev-btn "><i class="zmdi zmdi-chevron-left"></i> </a></li>';
...
//      console.log(currentPageIndex);
      ...
      if( i == currentPageIndex ){
         paginationHtml += 
        	'<li class="active"><a href="javascript:movePage(' + i + ')" class="single-btn">' + i + '</a></li>' ;
               
      }else{
         paginationHtml += 
        	 '<li><a href="javascript:movePage(' + i + ')" class="single-btn">' + i + '</a></li>' ;
   ...
   if(next){
      paginationHtml +=
    	  '<li><a href="javascript:movePage(' + (endPageIndex + 1) + ')" class="single-btn next-btn"><i class="zmdi zmdi-chevron-right"></i></a></li>'

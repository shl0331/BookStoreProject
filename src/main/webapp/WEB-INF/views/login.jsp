      ...
      $.ajax(
      {
           ...
           data : 
         {
           ...
           success : function(data, status, xhr) { // alertify or another welcome page 이동
              ...
              if( data ) {
            	  /* if(userDao.userName==admin) {window.location.href="admin";}else { */
            		  
            		  if(  $("#userEmail").val() == 'admin' ){
				...
				<div class="row">
					<div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb--30 mb-lg--0">
						...
						<div class="login-box">
							...
							<a href="register" class="btn btn-outlined   mr-3">Continue</a>
						</div>
					</div>
					<div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
						...
						<div class="col-md-12">
						<button id ="btn_login"  class="btn btn-outlined">Login</button>
						</div>
					</div>
				</div>
			</div>

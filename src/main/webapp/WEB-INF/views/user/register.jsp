			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb--30 mb-lg--0">
							...
							<div class="login-box">
								...
								<div class="row">
									<div class="col-md-12 col-12 mb--15">
										...
										<div class="invalid-feedback">유효한 이름이이 아닙니다.</div>
									</div>
									<div class="col-md-12 col-12 mb--15">
										<label for="email">Email Address</label>
										<input class="mb-0 form-control" type="email" id="userEmail"
											placeholder="Enter you email address here...">
										<div class="invalid-feedback">유효한 이메일이 아닙니다.</div>
									</div>
									<div class="col-12 mb--20">
										<label for="password">Password</label>
										<input class="mb-0 form-control" type="password" id="userPassword"
											placeholder="Enter you password here...">
										<div class="invalid-feedback">유효한 비밀번호가 아닙니다.</div>
									</div>
									<div class="col-12 mb--20">
										<label for="password">Password2</label>
										<input class="mb-0 form-control" type="password" id="userPassword2"
											placeholder="Enter you passworde2 here...">
						...
						<div class="col-md-12">
						<button id ="btn_register"  class="btn btn-outlined">Register</button>
						</div>
				</div>
			</div>
		</main>
